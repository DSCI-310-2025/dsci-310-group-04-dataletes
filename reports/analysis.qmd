...
Squared Error (RMSE), of approximately 72.16 weeks. This model has room
for improvement, given that the weeks_on_billboard values has an
Interquartile range of about 37 weeks.
...
has a prediction error of approximately 72.16 weeks, which is reasonable
given the variability in the data. However, there is room for
improvement, as the model explains 18.67% of the variability in
weeks_on_billboard.
...
![Scatterplots and boxplots for EDA](../data/visualizations.png){#fig-viz}
...
model.
![knn-tuning results](results/knn_tuning_results.png){#fig-results}
...
popularity of the album. The correlation was 0.35723461. The variable
